...
<h2 class="mb-4">Prediction page
</h1><hr></div>

    <section class="section-padding section-bg" style="min: width 300px;">
                <div class="container2" >
                    <div class="row1">
                        ...
                        <div class="col-lg-6 col-12">
                            <form action="process_pep_pred.php" method="post" enctype="multipart/form-data" onsubmit="return validateForm()" class="custom-form contact-form" role="form">
                                <div class="row">
